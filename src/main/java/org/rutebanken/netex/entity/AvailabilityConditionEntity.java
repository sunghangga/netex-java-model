...
public class AvailabilityConditionEntity {
	...
	public AvailabilityConditionEntity(String id, String version, LocalDateTime fromDate, LocalDateTime toDate,
			String validDayBits) {
		this.id = id;
	...
	public String toString() {
		return "AvailabilityConditionEntity [id=" + id + ", version=" + version + ", fromDate=" + fromDate + ", toDate="
				+ toDate + ", validDayBits=" + validDayBits + "]";
	}
