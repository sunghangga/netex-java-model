...
/**
 * <p>Java class for customerPurchasePackagesInFrame_RelStructure complex type.
 * 
...
public class CustomerPurchasePackagesInFrame_RelStructure
    extends FrameContainmentStructure
{
    ...
    public CustomerPurchasePackagesInFrame_RelStructure withCustomerPurchasePackage(CustomerPurchasePackage... values) {
        if (values!= null) {
            for (CustomerPurchasePackage value: values) {
                getCustomerPurchasePackage().add(value);
            }
        }
        return this;
    }

    public CustomerPurchasePackagesInFrame_RelStructure withCustomerPurchasePackage(Collection<CustomerPurchasePackage> values) {
        if (values!= null) {
            getCustomerPurchasePackage().addAll(values);
        }
        return this;
    }

    @Override
    public CustomerPurchasePackagesInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
