...
/**
 * <p>Java class for TypeOfTravelDocumentRefs_RelStructure complex type.
 * 
...
public class TypeOfTravelDocumentRefs_RelStructure
    extends OneToManyRelationshipStructure
{
    ...
    public TypeOfTravelDocumentRefs_RelStructure withTypeOfTravelDocumentRef(TypeOfTravelDocumentRefStructure... values) {
        if (values!= null) {
            for (TypeOfTravelDocumentRefStructure value: values) {
                getTypeOfTravelDocumentRef().add(value);
            }
        }
        return this;
    }

    public TypeOfTravelDocumentRefs_RelStructure withTypeOfTravelDocumentRef(Collection<TypeOfTravelDocumentRefStructure> values) {
        if (values!= null) {
            getTypeOfTravelDocumentRef().addAll(values);
        }
        return this;
    }

    @Override
    public TypeOfTravelDocumentRefs_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public TypeOfTravelDocumentRefs_RelStructure withId(String value) {
        setId(value);
        return this;
    }
