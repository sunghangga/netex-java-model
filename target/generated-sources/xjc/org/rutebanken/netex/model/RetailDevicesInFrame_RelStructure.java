...
/**
 * <p>Java class for retailDevicesInFrame_RelStructure complex type.
 * 
...
public class RetailDevicesInFrame_RelStructure
    extends FrameContainmentStructure
{
    ...
    public RetailDevicesInFrame_RelStructure withRetailDevice(RetailDevice... values) {
        if (values!= null) {
            for (RetailDevice value: values) {
                getRetailDevice().add(value);
            }
        }
        return this;
    }

    public RetailDevicesInFrame_RelStructure withRetailDevice(Collection<RetailDevice> values) {
        if (values!= null) {
            getRetailDevice().addAll(values);
        }
        return this;
    }

    @Override
    public RetailDevicesInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
