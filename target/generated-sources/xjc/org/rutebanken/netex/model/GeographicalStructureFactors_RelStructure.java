...
/**
 * <p>Java class for geographicalStructureFactors_RelStructure complex type.
 * 
...
public class GeographicalStructureFactors_RelStructure
    extends StrictContainmentAggregationStructure
{
    ...
    public GeographicalStructureFactors_RelStructure withGeographicalStructureFactorRefOrGeographicalStructureFactor(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getGeographicalStructureFactorRefOrGeographicalStructureFactor().add(value);
            }
        }
        return this;
    }

    public GeographicalStructureFactors_RelStructure withGeographicalStructureFactorRefOrGeographicalStructureFactor(Collection<Object> values) {
        if (values!= null) {
            getGeographicalStructureFactorRefOrGeographicalStructureFactor().addAll(values);
        }
        return this;
    }

    @Override
    public GeographicalStructureFactors_RelStructure withId(String value) {
        setId(value);
        return this;
    }
