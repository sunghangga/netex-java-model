    ...
    extends ContainmentAggregationStructure
{
    ...
    public CheckConstraints_RelStructure withCheckConstraintRefOrCheckConstraint(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getCheckConstraintRefOrCheckConstraint().add(value);
            }
        }
        return this;
    }

    public CheckConstraints_RelStructure withCheckConstraintRefOrCheckConstraint(Collection<Object> values) {
        if (values!= null) {
            getCheckConstraintRefOrCheckConstraint().addAll(values);
        }
        return this;
    }

    @Override
    public CheckConstraints_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public CheckConstraints_RelStructure withId(String value) {
        setId(value);
        return this;
    }
