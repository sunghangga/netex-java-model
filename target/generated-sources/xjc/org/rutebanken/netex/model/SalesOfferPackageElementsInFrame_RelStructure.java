...
/**
 * <p>Java class for salesOfferPackageElementsInFrame_RelStructure complex type.
 * 
...
public class SalesOfferPackageElementsInFrame_RelStructure
    extends FrameContainmentStructure
{
    ...
    public SalesOfferPackageElementsInFrame_RelStructure withSalesOfferPackageElement(SalesOfferPackageElement... values) {
        if (values!= null) {
            for (SalesOfferPackageElement value: values) {
                getSalesOfferPackageElement().add(value);
            }
        }
        return this;
    }

    public SalesOfferPackageElementsInFrame_RelStructure withSalesOfferPackageElement(Collection<SalesOfferPackageElement> values) {
        if (values!= null) {
            getSalesOfferPackageElement().addAll(values);
        }
        return this;
    }

    @Override
    public SalesOfferPackageElementsInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
