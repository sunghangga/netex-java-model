    ...
    extends ContainmentAggregationStructure
{
    ...
    public DayTypeAssignmentsInFrame_RelStructure withDayTypeAssignment(DayTypeAssignment... values) {
        if (values!= null) {
            for (DayTypeAssignment value: values) {
                getDayTypeAssignment().add(value);
            }
        }
        return this;
    }

    public DayTypeAssignmentsInFrame_RelStructure withDayTypeAssignment(Collection<DayTypeAssignment> values) {
        if (values!= null) {
            getDayTypeAssignment().addAll(values);
        }
        return this;
    }

    @Override
    public DayTypeAssignmentsInFrame_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public DayTypeAssignmentsInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
