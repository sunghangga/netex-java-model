    ...
    extends ContainmentAggregationStructure
{
    ...
    public DisplayAssignmentsInFrame_RelStructure withDisplayAssignment(DisplayAssignment... values) {
        if (values!= null) {
            for (DisplayAssignment value: values) {
                getDisplayAssignment().add(value);
            }
        }
        return this;
    }

    public DisplayAssignmentsInFrame_RelStructure withDisplayAssignment(Collection<DisplayAssignment> values) {
        if (values!= null) {
            getDisplayAssignment().addAll(values);
        }
        return this;
    }

    @Override
    public DisplayAssignmentsInFrame_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public DisplayAssignmentsInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
