...
/**
 * <p>Java class for customerAccountRefs_RelStructure complex type.
 * 
...
public class CustomerAccountRefs_RelStructure
    extends OneToManyRelationshipStructure
{
    ...
    public CustomerAccountRefs_RelStructure withCustomerAccountRef(CustomerAccountRefStructure... values) {
        if (values!= null) {
            for (CustomerAccountRefStructure value: values) {
                getCustomerAccountRef().add(value);
            }
        }
        return this;
    }

    public CustomerAccountRefs_RelStructure withCustomerAccountRef(Collection<CustomerAccountRefStructure> values) {
        if (values!= null) {
            getCustomerAccountRef().addAll(values);
        }
        return this;
    }

    @Override
    public CustomerAccountRefs_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public CustomerAccountRefs_RelStructure withId(String value) {
        setId(value);
        return this;
    }
