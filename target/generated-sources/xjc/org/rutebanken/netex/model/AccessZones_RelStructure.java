    ...
    extends ContainmentAggregationStructure
{
    ...
    public AccessZones_RelStructure withAccessZoneRefOrAccessZone(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getAccessZoneRefOrAccessZone().add(value);
            }
        }
        return this;
    }

    public AccessZones_RelStructure withAccessZoneRefOrAccessZone(Collection<Object> values) {
        if (values!= null) {
            getAccessZoneRefOrAccessZone().addAll(values);
        }
        return this;
    }

    @Override
    public AccessZones_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public AccessZones_RelStructure withId(String value) {
        setId(value);
        return this;
    }
