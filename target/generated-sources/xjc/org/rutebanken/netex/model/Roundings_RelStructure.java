...
/**
 * <p>Java class for roundings_RelStructure complex type.
 * 
...
public class Roundings_RelStructure
    extends FrameContainmentStructure
{
    ...
    public Roundings_RelStructure withRounding(Rounding... values) {
        if (values!= null) {
            for (Rounding value: values) {
                getRounding().add(value);
            }
        }
        return this;
    }

    public Roundings_RelStructure withRounding(Collection<Rounding> values) {
        if (values!= null) {
            getRounding().addAll(values);
        }
        return this;
    }

    @Override
    public Roundings_RelStructure withId(String value) {
        setId(value);
        return this;
    }
