    ...
    extends ContainmentAggregationStructure
{
    ...
    public Levels_RelStructure withLevelRefOrLevel(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getLevelRefOrLevel().add(value);
            }
        }
        return this;
    }

    public Levels_RelStructure withLevelRefOrLevel(Collection<Object> values) {
        if (values!= null) {
            getLevelRefOrLevel().addAll(values);
        }
        return this;
    }

    @Override
    public Levels_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public Levels_RelStructure withId(String value) {
        setId(value);
        return this;
    }
