...
/**
 * <p>Java class for customerEligibilityRefs_RelStructure complex type.
 * 
...
public class CustomerEligibilityRefs_RelStructure
    extends OneToManyRelationshipStructure
{
    ...
    public CustomerEligibilityRefs_RelStructure withCustomerEligibilityRef(JAXBElement<? extends CustomerEligibilityRefStructure> ... values) {
        if (values!= null) {
            for (JAXBElement<? extends CustomerEligibilityRefStructure> value: values) {
                getCustomerEligibilityRef().add(value);
            }
        }
        return this;
    }

    public CustomerEligibilityRefs_RelStructure withCustomerEligibilityRef(Collection<JAXBElement<? extends CustomerEligibilityRefStructure>> values) {
        if (values!= null) {
            getCustomerEligibilityRef().addAll(values);
        }
        return this;
    }

    @Override
    public CustomerEligibilityRefs_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public CustomerEligibilityRefs_RelStructure withId(String value) {
        setId(value);
        return this;
    }
