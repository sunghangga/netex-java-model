    ...
    extends StrictContainmentAggregationStructure
{
    ...
    public JourneyRunTimes_RelStructure withJourneyRunTime(JourneyRunTime... values) {
        if (values!= null) {
            for (JourneyRunTime value: values) {
                getJourneyRunTime().add(value);
            }
        }
        return this;
    }

    public JourneyRunTimes_RelStructure withJourneyRunTime(Collection<JourneyRunTime> values) {
        if (values!= null) {
            getJourneyRunTime().addAll(values);
        }
        return this;
    }

    @Override
    public JourneyRunTimes_RelStructure withId(String value) {
        setId(value);
        return this;
    }
