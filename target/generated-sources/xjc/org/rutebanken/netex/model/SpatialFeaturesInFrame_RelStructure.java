    ...
    extends ContainmentAggregationStructure
{
    ...
    public SpatialFeaturesInFrame_RelStructure withSimpleFeatureOrComplexFeature(GroupOfPoints_VersionStructure... values) {
        if (values!= null) {
            for (GroupOfPoints_VersionStructure value: values) {
                getSimpleFeatureOrComplexFeature().add(value);
            }
        }
        return this;
    }

    public SpatialFeaturesInFrame_RelStructure withSimpleFeatureOrComplexFeature(Collection<GroupOfPoints_VersionStructure> values) {
        if (values!= null) {
            getSimpleFeatureOrComplexFeature().addAll(values);
        }
        return this;
    }

    @Override
    public SpatialFeaturesInFrame_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public SpatialFeaturesInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
