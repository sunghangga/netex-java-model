...
/**
 * <p>Java class for monthValidityOffsets_RelStructure complex type.
 * 
...
public class MonthValidityOffsets_RelStructure
    extends StrictContainmentAggregationStructure
{
    ...
    public MonthValidityOffsets_RelStructure withMonthValidityOffset(MonthValidityOffset... values) {
        if (values!= null) {
            for (MonthValidityOffset value: values) {
                getMonthValidityOffset().add(value);
            }
        }
        return this;
    }

    public MonthValidityOffsets_RelStructure withMonthValidityOffset(Collection<MonthValidityOffset> values) {
        if (values!= null) {
            getMonthValidityOffset().addAll(values);
        }
        return this;
    }

    @Override
    public MonthValidityOffsets_RelStructure withId(String value) {
        setId(value);
        return this;
    }
