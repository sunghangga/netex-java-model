...
/**
 * <p>Java class for vehicleServiceParts_RelStructure complex type.
 * 
...
public class VehicleServiceParts_RelStructure
    extends ContainmentAggregationStructure
{
    ...
    public VehicleServiceParts_RelStructure withVehicleServicePartRefOrVehicleServicePart(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getVehicleServicePartRefOrVehicleServicePart().add(value);
            }
        }
        return this;
    }

    public VehicleServiceParts_RelStructure withVehicleServicePartRefOrVehicleServicePart(Collection<Object> values) {
        if (values!= null) {
            getVehicleServicePartRefOrVehicleServicePart().addAll(values);
        }
        return this;
    }

    @Override
    public VehicleServiceParts_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public VehicleServiceParts_RelStructure withId(String value) {
        setId(value);
        return this;
    }
