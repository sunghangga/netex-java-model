    ...
    extends ContainmentAggregationStructure
{
    ...
    public OperationalContextsInFrame_RelStructure withOperationalContext(OperationalContext... values) {
        if (values!= null) {
            for (OperationalContext value: values) {
                getOperationalContext().add(value);
            }
        }
        return this;
    }
    ...
    public OperationalContextsInFrame_RelStructure withOperationalContext(Collection<OperationalContext> values) {
        if (values!= null) {
            getOperationalContext().addAll(values);
        }
        return this;
    }
    ...
    @Override
    public OperationalContextsInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
