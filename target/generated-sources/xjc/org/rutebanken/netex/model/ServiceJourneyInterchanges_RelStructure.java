...
/**
 * <p>Java class for serviceJourneyInterchanges_RelStructure complex type.
 * 
...
public class ServiceJourneyInterchanges_RelStructure
    extends StrictContainmentAggregationStructure
{
    ...
    @XmlElements({
        ...
        @XmlElement(name = "ServiceJourneyInterchangeView", type = ServiceJourneyInterchange_DerivedViewStructure.class)
    })
     ...
     * {@link ServiceJourneyInterchange_DerivedViewStructure }
     * 
     * 
     */
    ...
    public ServiceJourneyInterchanges_RelStructure withServiceJourneyInterchangeRefOrServiceJourneyInterchangeOrServiceJourneyInterchangeView(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getServiceJourneyInterchangeRefOrServiceJourneyInterchangeOrServiceJourneyInterchangeView().add(value);
            }
        }
        return this;
    }

    public ServiceJourneyInterchanges_RelStructure withServiceJourneyInterchangeRefOrServiceJourneyInterchangeOrServiceJourneyInterchangeView(Collection<Object> values) {
        if (values!= null) {
            getServiceJourneyInterchangeRefOrServiceJourneyInterchangeOrServiceJourneyInterchangeView().addAll(values);
        }
        return this;
    }

    @Override
    public ServiceJourneyInterchanges_RelStructure withId(String value) {
        setId(value);
        return this;
    }
