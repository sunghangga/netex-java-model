    ...
    extends ContainmentAggregationStructure
{
    ...
    public ValidityTriggers_RelStructure withValidityTrigger(ValidityTrigger_VersionStructure... values) {
        if (values!= null) {
            for (ValidityTrigger_VersionStructure value: values) {
                getValidityTrigger().add(value);
            }
        }
        return this;
    }
    ...
    public ValidityTriggers_RelStructure withValidityTrigger(Collection<ValidityTrigger_VersionStructure> values) {
        if (values!= null) {
            getValidityTrigger().addAll(values);
        }
        return this;
    }
    ...
    @Override
    public ValidityTriggers_RelStructure withId(String value) {
        setId(value);
        return this;
    }
