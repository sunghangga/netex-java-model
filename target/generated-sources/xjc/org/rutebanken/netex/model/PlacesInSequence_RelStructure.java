    ...
    extends StrictContainmentAggregationStructure
{
    ...
    public PlacesInSequence_RelStructure withPlaceInSequence(PlaceInSequence... values) {
        if (values!= null) {
            for (PlaceInSequence value: values) {
                getPlaceInSequence().add(value);
            }
        }
        return this;
    }

    public PlacesInSequence_RelStructure withPlaceInSequence(Collection<PlaceInSequence> values) {
        if (values!= null) {
            getPlaceInSequence().addAll(values);
        }
        return this;
    }

    @Override
    public PlacesInSequence_RelStructure withId(String value) {
        setId(value);
        return this;
    }
