...
/**
 * <p>Java class for usageParameterRefs_RelStructure complex type.
 * 
...
public class UsageParameterRefs_RelStructure
    extends OneToManyRelationshipStructure
{
    ...
    public UsageParameterRefs_RelStructure withUsageParameterRef(JAXBElement<? extends UsageParameterRefStructure> ... values) {
        if (values!= null) {
            for (JAXBElement<? extends UsageParameterRefStructure> value: values) {
                getUsageParameterRef().add(value);
            }
        }
        return this;
    }
    ...
    public UsageParameterRefs_RelStructure withUsageParameterRef(Collection<JAXBElement<? extends UsageParameterRefStructure>> values) {
        if (values!= null) {
            getUsageParameterRef().addAll(values);
        }
        return this;
    }
    ...
    @Override
    public UsageParameterRefs_RelStructure withId(String value) {
        setId(value);
        return this;
    }
