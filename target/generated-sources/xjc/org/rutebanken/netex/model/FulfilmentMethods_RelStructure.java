...
/**
 * <p>Java class for fulfilmentMethods_RelStructure complex type.
 * 
...
public class FulfilmentMethods_RelStructure
    extends ContainmentAggregationStructure
{
    ...
    public FulfilmentMethods_RelStructure withFulfilmentMethodRefOrFulfilmentMethod(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getFulfilmentMethodRefOrFulfilmentMethod().add(value);
            }
        }
        return this;
    }

    public FulfilmentMethods_RelStructure withFulfilmentMethodRefOrFulfilmentMethod(Collection<Object> values) {
        if (values!= null) {
            getFulfilmentMethodRefOrFulfilmentMethod().addAll(values);
        }
        return this;
    }

    @Override
    public FulfilmentMethods_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public FulfilmentMethods_RelStructure withId(String value) {
        setId(value);
        return this;
    }
