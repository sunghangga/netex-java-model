    ...
    extends ContainmentAggregationStructure
{
    ...
    public ResponsibilitySetsInFrame_RelStructure withResponsibilitySet(ResponsibilitySet... values) {
        if (values!= null) {
            for (ResponsibilitySet value: values) {
                getResponsibilitySet().add(value);
            }
        }
        return this;
    }
    ...
    public ResponsibilitySetsInFrame_RelStructure withResponsibilitySet(Collection<ResponsibilitySet> values) {
        if (values!= null) {
            getResponsibilitySet().addAll(values);
        }
        return this;
    }
    ...
    @Override
    public ResponsibilitySetsInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
