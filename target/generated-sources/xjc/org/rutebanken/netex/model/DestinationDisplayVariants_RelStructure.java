...
@XmlSeeAlso({
    org.rutebanken.netex.model.DestinationDisplay_VersionStructure.Variants.class
})
    ...
    extends StrictContainmentAggregationStructure
{
    ...
    public DestinationDisplayVariants_RelStructure withDestinationDisplayVariant(DestinationDisplayVariant... values) {
        if (values!= null) {
    ...
    public DestinationDisplayVariants_RelStructure withDestinationDisplayVariant(Collection<DestinationDisplayVariant> values) {
        if (values!= null) {
    ...
    @Override
    public DestinationDisplayVariants_RelStructure withId(String value) {
        setId(value);
        return this;
    }
