...
/**
 * <p>Java class for salesTransactions_RelStructure complex type.
 * 
...
public class SalesTransactions_RelStructure
    extends ContainmentAggregationStructure
{
    ...
    public SalesTransactions_RelStructure withSalesTransactionRefOrSalesTransaction(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getSalesTransactionRefOrSalesTransaction().add(value);
            }
        }
        return this;
    }

    public SalesTransactions_RelStructure withSalesTransactionRefOrSalesTransaction(Collection<Object> values) {
        if (values!= null) {
            getSalesTransactionRefOrSalesTransaction().addAll(values);
        }
        return this;
    }

    @Override
    public SalesTransactions_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public SalesTransactions_RelStructure withId(String value) {
        setId(value);
        return this;
    }
