    ...
    extends ContainmentAggregationStructure
{
    ...
    public GroupOfTimebands_RelStructure withGroupOfTimebandsRefOrGroupOfTimebands(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getGroupOfTimebandsRefOrGroupOfTimebands().add(value);
            }
        }
        return this;
    }

    public GroupOfTimebands_RelStructure withGroupOfTimebandsRefOrGroupOfTimebands(Collection<Object> values) {
        if (values!= null) {
            getGroupOfTimebandsRefOrGroupOfTimebands().addAll(values);
        }
        return this;
    }

    @Override
    public GroupOfTimebands_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public GroupOfTimebands_RelStructure withId(String value) {
        setId(value);
        return this;
    }
