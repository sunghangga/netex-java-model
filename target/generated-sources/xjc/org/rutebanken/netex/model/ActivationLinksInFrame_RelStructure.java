    ...
    extends ContainmentAggregationStructure
{
    ...
    public ActivationLinksInFrame_RelStructure withActivationLink(ActivationLink... values) {
        if (values!= null) {
            for (ActivationLink value: values) {
                getActivationLink().add(value);
            }
        }
        return this;
    }

    public ActivationLinksInFrame_RelStructure withActivationLink(Collection<ActivationLink> values) {
        if (values!= null) {
            getActivationLink().addAll(values);
        }
        return this;
    }

    @Override
    public ActivationLinksInFrame_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public ActivationLinksInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
