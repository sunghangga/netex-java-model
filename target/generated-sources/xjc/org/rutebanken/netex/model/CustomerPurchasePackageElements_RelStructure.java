...
/**
 * <p>Java class for customerPurchasePackageElements_RelStructure complex type.
 * 
...
public class CustomerPurchasePackageElements_RelStructure
    extends ContainmentAggregationStructure
{
    ...
    public CustomerPurchasePackageElements_RelStructure withCustomerPurchasePackageElement(CustomerPurchasePackageElement... values) {
        if (values!= null) {
            for (CustomerPurchasePackageElement value: values) {
                getCustomerPurchasePackageElement().add(value);
            }
        }
        return this;
    }

    public CustomerPurchasePackageElements_RelStructure withCustomerPurchasePackageElement(Collection<CustomerPurchasePackageElement> values) {
        if (values!= null) {
            getCustomerPurchasePackageElement().addAll(values);
        }
        return this;
    }

    @Override
    public CustomerPurchasePackageElements_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public CustomerPurchasePackageElements_RelStructure withId(String value) {
        setId(value);
        return this;
    }
