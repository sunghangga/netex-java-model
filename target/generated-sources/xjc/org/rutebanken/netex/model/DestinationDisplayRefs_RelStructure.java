    ...
    extends OneToManyRelationshipStructure
{
    ...
    public DestinationDisplayRefs_RelStructure withDestinationDisplayRef(DestinationDisplayRefStructure... values) {
        if (values!= null) {
            for (DestinationDisplayRefStructure value: values) {
                getDestinationDisplayRef().add(value);
            }
        }
        return this;
    }

    public DestinationDisplayRefs_RelStructure withDestinationDisplayRef(Collection<DestinationDisplayRefStructure> values) {
        if (values!= null) {
            getDestinationDisplayRef().addAll(values);
        }
        return this;
    }

    @Override
    public DestinationDisplayRefs_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public DestinationDisplayRefs_RelStructure withId(String value) {
        setId(value);
        return this;
    }
