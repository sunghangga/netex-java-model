    ...
    extends ContainmentAggregationStructure
{
    ...
    public DestinationDisplaysInFrame_RelStructure withDestinationDisplay(DestinationDisplay... values) {
        if (values!= null) {
            for (DestinationDisplay value: values) {
    ...
    public DestinationDisplaysInFrame_RelStructure withDestinationDisplay(Collection<DestinationDisplay> values) {
        if (values!= null) {
    ...
    @Override
    public DestinationDisplaysInFrame_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public DestinationDisplaysInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
