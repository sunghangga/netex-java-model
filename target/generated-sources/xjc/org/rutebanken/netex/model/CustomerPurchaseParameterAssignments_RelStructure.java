...
/**
 * <p>Java class for customerPurchaseParameterAssignments_RelStructure complex type.
 * 
...
public class CustomerPurchaseParameterAssignments_RelStructure
    extends ContainmentAggregationStructure
{
    ...
    /**
     * Gets the value of the customerPurchaseParameterAssignment property.
     * 
     * <p>
    ...
    public CustomerPurchaseParameterAssignments_RelStructure withCustomerPurchaseParameterAssignment(CustomerPurchaseParameterAssignment... values) {
        if (values!= null) {
            for (CustomerPurchaseParameterAssignment value: values) {
                getCustomerPurchaseParameterAssignment().add(value);
            }
        }
        return this;
    }

    public CustomerPurchaseParameterAssignments_RelStructure withCustomerPurchaseParameterAssignment(Collection<CustomerPurchaseParameterAssignment> values) {
        if (values!= null) {
            getCustomerPurchaseParameterAssignment().addAll(values);
        }
        return this;
    }

    @Override
    public CustomerPurchaseParameterAssignments_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public CustomerPurchaseParameterAssignments_RelStructure withId(String value) {
        setId(value);
        return this;
    }
