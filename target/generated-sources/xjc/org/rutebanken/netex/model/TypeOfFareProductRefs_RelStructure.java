...
/**
 * <p>Java class for typeOfFareProductRefs_RelStructure complex type.
 * 
...
public class TypeOfFareProductRefs_RelStructure
    extends OneToManyRelationshipStructure
{
    ...
    public TypeOfFareProductRefs_RelStructure withTypeOfFareProductRef(TypeOfFareProductRefStructure... values) {
        if (values!= null) {
            for (TypeOfFareProductRefStructure value: values) {
                getTypeOfFareProductRef().add(value);
            }
        }
        return this;
    }

    public TypeOfFareProductRefs_RelStructure withTypeOfFareProductRef(Collection<TypeOfFareProductRefStructure> values) {
        if (values!= null) {
            getTypeOfFareProductRef().addAll(values);
        }
        return this;
    }

    @Override
    public TypeOfFareProductRefs_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public TypeOfFareProductRefs_RelStructure withId(String value) {
        setId(value);
        return this;
    }
