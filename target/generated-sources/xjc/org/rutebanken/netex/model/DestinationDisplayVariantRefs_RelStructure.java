    ...
    extends OneToManyRelationshipStructure
{
    ...
    public DestinationDisplayVariantRefs_RelStructure withDestinationDisplayVariantRef(DestinationDisplayVariantRefStructure... values) {
        if (values!= null) {
            for (DestinationDisplayVariantRefStructure value: values) {
                getDestinationDisplayVariantRef().add(value);
            }
        }
        return this;
    }

    public DestinationDisplayVariantRefs_RelStructure withDestinationDisplayVariantRef(Collection<DestinationDisplayVariantRefStructure> values) {
        if (values!= null) {
            getDestinationDisplayVariantRef().addAll(values);
        }
        return this;
    }

    @Override
    public DestinationDisplayVariantRefs_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public DestinationDisplayVariantRefs_RelStructure withId(String value) {
        setId(value);
        return this;
    }
