    ...
    extends ContainmentAggregationStructure
{
    ...
    public AccessSpaces_RelStructure withAccessSpaceRefOrAccessSpace(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getAccessSpaceRefOrAccessSpace().add(value);
            }
        }
        return this;
    }

    public AccessSpaces_RelStructure withAccessSpaceRefOrAccessSpace(Collection<Object> values) {
        if (values!= null) {
            getAccessSpaceRefOrAccessSpace().addAll(values);
        }
        return this;
    }

    @Override
    public AccessSpaces_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public AccessSpaces_RelStructure withId(String value) {
        setId(value);
        return this;
    }
