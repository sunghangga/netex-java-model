    ...
    extends ContainmentAggregationStructure
{
    ...
    public TopographicPlaces_RelStructure withTopographicPlaceRefAndTopographicPlace(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getTopographicPlaceRefAndTopographicPlace().add(value);
            }
        }
        return this;
    }

    public TopographicPlaces_RelStructure withTopographicPlaceRefAndTopographicPlace(Collection<Object> values) {
        if (values!= null) {
            getTopographicPlaceRefAndTopographicPlace().addAll(values);
        }
        return this;
    }

    @Override
    public TopographicPlaces_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public TopographicPlaces_RelStructure withId(String value) {
        setId(value);
        return this;
    }
