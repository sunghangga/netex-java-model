...
/**
 * <p>Java class for fareTableColumns_RelStructure complex type.
 * 
...
public class FareTableColumns_RelStructure
    extends StrictContainmentAggregationStructure
{
    ...
    /**
     * Gets the value of the fareTableColumn property.
     * 
     * <p>
    ...
    public FareTableColumns_RelStructure withFareTableColumn(FareTableColumn... values) {
        if (values!= null) {
            for (FareTableColumn value: values) {
                getFareTableColumn().add(value);
            }
        }
        return this;
    }

    public FareTableColumns_RelStructure withFareTableColumn(Collection<FareTableColumn> values) {
        if (values!= null) {
            getFareTableColumn().addAll(values);
        }
        return this;
    }

    @Override
    public FareTableColumns_RelStructure withId(String value) {
        setId(value);
        return this;
    }
