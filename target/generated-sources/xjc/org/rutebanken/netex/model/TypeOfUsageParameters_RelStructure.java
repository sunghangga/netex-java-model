...
/**
 * <p>Java class for typeOfUsageParameters_RelStructure complex type.
 * 
...
public class TypeOfUsageParameters_RelStructure
    extends ContainmentAggregationStructure
{
    ...
    public TypeOfUsageParameters_RelStructure withTypeOfUsageParameterRefOrTypeOfUsageParameter(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getTypeOfUsageParameterRefOrTypeOfUsageParameter().add(value);
            }
        }
        return this;
    }

    public TypeOfUsageParameters_RelStructure withTypeOfUsageParameterRefOrTypeOfUsageParameter(Collection<Object> values) {
        if (values!= null) {
            getTypeOfUsageParameterRefOrTypeOfUsageParameter().addAll(values);
        }
        return this;
    }

    @Override
    public TypeOfUsageParameters_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public TypeOfUsageParameters_RelStructure withId(String value) {
        setId(value);
        return this;
    }
