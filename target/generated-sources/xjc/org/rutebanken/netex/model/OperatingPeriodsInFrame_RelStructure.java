    ...
    extends ContainmentAggregationStructure
{
    ...
    public OperatingPeriodsInFrame_RelStructure withOperatingPeriodOrUicOperatingPeriod(OperatingPeriod_VersionStructure... values) {
        if (values!= null) {
            for (OperatingPeriod_VersionStructure value: values) {
                getOperatingPeriodOrUicOperatingPeriod().add(value);
            }
        }
        return this;
    }

    public OperatingPeriodsInFrame_RelStructure withOperatingPeriodOrUicOperatingPeriod(Collection<OperatingPeriod_VersionStructure> values) {
        if (values!= null) {
            getOperatingPeriodOrUicOperatingPeriod().addAll(values);
        }
        return this;
    }

    @Override
    public OperatingPeriodsInFrame_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public OperatingPeriodsInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
