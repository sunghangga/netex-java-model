    ...
    extends ContainmentAggregationStructure
{
    ...
    public CrewBasesInFrame_RelStructure withCrewBase(CrewBase... values) {
        if (values!= null) {
            for (CrewBase value: values) {
                getCrewBase().add(value);
            }
        }
        return this;
    }

    public CrewBasesInFrame_RelStructure withCrewBase(Collection<CrewBase> values) {
        if (values!= null) {
            getCrewBase().addAll(values);
        }
        return this;
    }

    @Override
    public CrewBasesInFrame_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public CrewBasesInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
