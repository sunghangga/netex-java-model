    ...
    extends StrictContainmentAggregationStructure
{
    ...
    public DayTypeAssignments_RelStructure withDayTypeAssignment(DayTypeAssignment... values) {
        if (values!= null) {
    ...
    public DayTypeAssignments_RelStructure withDayTypeAssignment(Collection<DayTypeAssignment> values) {
        if (values!= null) {
    ...
    @Override
    public DayTypeAssignments_RelStructure withId(String value) {
        setId(value);
        return this;
    }
