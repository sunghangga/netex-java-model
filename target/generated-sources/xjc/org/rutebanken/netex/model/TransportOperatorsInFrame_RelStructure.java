    ...
    extends ContainmentAggregationStructure
{
    ...
    public TransportOperatorsInFrame_RelStructure withAuthorityOrOperator(Organisation_VersionStructure... values) {
        if (values!= null) {
            for (Organisation_VersionStructure value: values) {
                getAuthorityOrOperator().add(value);
            }
        }
        return this;
    }
    ...
    public TransportOperatorsInFrame_RelStructure withAuthorityOrOperator(Collection<Organisation_VersionStructure> values) {
        if (values!= null) {
            getAuthorityOrOperator().addAll(values);
        }
        return this;
    }
    ...
    @Override
    public TransportOperatorsInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
