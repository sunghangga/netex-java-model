    ...
    extends ContainmentAggregationStructure
{
    ...
    public AllowedLineDirections_RelStructure withAllowedLineDirectionRefOrAllowedLineDirection(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getAllowedLineDirectionRefOrAllowedLineDirection().add(value);
            }
        }
        return this;
    }

    public AllowedLineDirections_RelStructure withAllowedLineDirectionRefOrAllowedLineDirection(Collection<Object> values) {
        if (values!= null) {
            getAllowedLineDirectionRefOrAllowedLineDirection().addAll(values);
        }
        return this;
    }

    @Override
    public AllowedLineDirections_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public AllowedLineDirections_RelStructure withId(String value) {
        setId(value);
        return this;
    }
