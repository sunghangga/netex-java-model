    ...
    extends ContainmentAggregationStructure
{
    ...
    public Equipments_RelStructure withEquipmentRefOrEquipment(JAXBElement<?> ... values) {
        if (values!= null) {
            for (JAXBElement<?> value: values) {
                getEquipmentRefOrEquipment().add(value);
            }
        }
        return this;
    }

    public Equipments_RelStructure withEquipmentRefOrEquipment(Collection<JAXBElement<?>> values) {
        if (values!= null) {
            getEquipmentRefOrEquipment().addAll(values);
        }
        return this;
    }

    @Override
    public Equipments_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public Equipments_RelStructure withId(String value) {
        setId(value);
        return this;
    }
