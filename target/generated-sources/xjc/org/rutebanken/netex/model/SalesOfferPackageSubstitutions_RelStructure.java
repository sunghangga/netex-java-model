...
/**
 * <p>Java class for salesOfferPackageSubstitutions_RelStructure complex type.
 * 
...
public class SalesOfferPackageSubstitutions_RelStructure
    extends ContainmentAggregationStructure
{
    ...
    public SalesOfferPackageSubstitutions_RelStructure withSalesOfferPackageSubstitutionRefOrSalesOfferPackageSubstitution(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getSalesOfferPackageSubstitutionRefOrSalesOfferPackageSubstitution().add(value);
            }
        }
        return this;
    }

    public SalesOfferPackageSubstitutions_RelStructure withSalesOfferPackageSubstitutionRefOrSalesOfferPackageSubstitution(Collection<Object> values) {
        if (values!= null) {
            getSalesOfferPackageSubstitutionRefOrSalesOfferPackageSubstitution().addAll(values);
        }
        return this;
    }

    @Override
    public SalesOfferPackageSubstitutions_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public SalesOfferPackageSubstitutions_RelStructure withId(String value) {
        setId(value);
        return this;
    }
