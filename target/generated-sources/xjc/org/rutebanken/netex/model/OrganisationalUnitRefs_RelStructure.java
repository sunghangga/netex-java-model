    ...
    extends OneToManyRelationshipStructure
{
    ...
    public OrganisationalUnitRefs_RelStructure withOrganisationalUnitRef(OrganisationalUnitRefStructure... values) {
        if (values!= null) {
            for (OrganisationalUnitRefStructure value: values) {
                getOrganisationalUnitRef().add(value);
            }
        }
        return this;
    }

    public OrganisationalUnitRefs_RelStructure withOrganisationalUnitRef(Collection<OrganisationalUnitRefStructure> values) {
        if (values!= null) {
            getOrganisationalUnitRef().addAll(values);
        }
        return this;
    }

    @Override
    public OrganisationalUnitRefs_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public OrganisationalUnitRefs_RelStructure withId(String value) {
        setId(value);
        return this;
    }
