    ...
    extends ContainmentAggregationStructure
{
    ...
    public NoticeAssignmentViews_RelStructure withNoticeAssignmentView(NoticeAssignmentView... values) {
        if (values!= null) {
            for (NoticeAssignmentView value: values) {
                getNoticeAssignmentView().add(value);
            }
        }
        return this;
    }

    public NoticeAssignmentViews_RelStructure withNoticeAssignmentView(Collection<NoticeAssignmentView> values) {
        if (values!= null) {
            getNoticeAssignmentView().addAll(values);
        }
        return this;
    }

    @Override
    public NoticeAssignmentViews_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public NoticeAssignmentViews_RelStructure withId(String value) {
        setId(value);
        return this;
    }
