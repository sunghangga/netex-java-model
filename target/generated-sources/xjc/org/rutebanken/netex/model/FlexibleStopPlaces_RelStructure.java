    ...
    extends ContainmentAggregationStructure
{
    ...
    public FlexibleStopPlaces_RelStructure withFlexibleStopPlaceRefOrFlexibleStopPlace(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getFlexibleStopPlaceRefOrFlexibleStopPlace().add(value);
            }
        }
        return this;
    }

    public FlexibleStopPlaces_RelStructure withFlexibleStopPlaceRefOrFlexibleStopPlace(Collection<Object> values) {
        if (values!= null) {
            getFlexibleStopPlaceRefOrFlexibleStopPlace().addAll(values);
        }
        return this;
    }

    @Override
    public FlexibleStopPlaces_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public FlexibleStopPlaces_RelStructure withId(String value) {
        setId(value);
        return this;
    }
