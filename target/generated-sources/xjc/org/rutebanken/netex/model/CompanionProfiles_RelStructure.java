...
/**
 * <p>Java class for companionProfiles_RelStructure complex type.
 * 
...
public class CompanionProfiles_RelStructure
    extends OneToManyRelationshipStructure
{
    ...
    public CompanionProfiles_RelStructure withCompanionProfileRefOrCompanionProfile(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getCompanionProfileRefOrCompanionProfile().add(value);
            }
        }
        return this;
    }

    public CompanionProfiles_RelStructure withCompanionProfileRefOrCompanionProfile(Collection<Object> values) {
        if (values!= null) {
            getCompanionProfileRefOrCompanionProfile().addAll(values);
        }
        return this;
    }

    @Override
    public CompanionProfiles_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public CompanionProfiles_RelStructure withId(String value) {
        setId(value);
        return this;
    }
