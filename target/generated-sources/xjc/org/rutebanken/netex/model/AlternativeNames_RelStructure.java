    ...
    extends StrictContainmentAggregationStructure
{
    ...
    public AlternativeNames_RelStructure withAlternativeName(AlternativeName... values) {
        if (values!= null) {
            for (AlternativeName value: values) {
                getAlternativeName().add(value);
            }
        }
        return this;
    }

    public AlternativeNames_RelStructure withAlternativeName(Collection<AlternativeName> values) {
        if (values!= null) {
            getAlternativeName().addAll(values);
        }
        return this;
    }

    @Override
    public AlternativeNames_RelStructure withId(String value) {
        setId(value);
        return this;
    }
