...
/**
 * <p>Java class for Duty_VersionStructure complex type.
 * 
    ...
    extends DataManagedObjectStructure
{
    ...
    @Override
    public Duty_VersionStructure withValidBetween(Collection<ValidBetween> values) {
        if (values!= null) {
    ...
    @Override
    public Duty_VersionStructure withCreated(LocalDateTime value) {
        setCreated(value);
        return this;
    }

    @Override
    public Duty_VersionStructure withChanged(LocalDateTime value) {
        setChanged(value);
        return this;
    }
