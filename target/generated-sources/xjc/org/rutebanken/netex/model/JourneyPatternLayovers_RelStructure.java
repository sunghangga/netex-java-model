    ...
    extends StrictContainmentAggregationStructure
{
    ...
    /**
     * Gets the value of the journeyPatternLayover property.
     * 
     * <p>
    ...
    public JourneyPatternLayovers_RelStructure withJourneyPatternLayover(JourneyPatternLayover... values) {
        if (values!= null) {
            for (JourneyPatternLayover value: values) {
                getJourneyPatternLayover().add(value);
            }
        }
        return this;
    }

    public JourneyPatternLayovers_RelStructure withJourneyPatternLayover(Collection<JourneyPatternLayover> values) {
        if (values!= null) {
            getJourneyPatternLayover().addAll(values);
        }
        return this;
    }

    @Override
    public JourneyPatternLayovers_RelStructure withId(String value) {
        setId(value);
        return this;
    }
