    ...
    extends ContainmentAggregationStructure
{
    ...
    public ParkingCapacities_RelStructure withParkingCapacityRefOrParkingCapacity(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getParkingCapacityRefOrParkingCapacity().add(value);
            }
        }
        return this;
    }

    public ParkingCapacities_RelStructure withParkingCapacityRefOrParkingCapacity(Collection<Object> values) {
        if (values!= null) {
            getParkingCapacityRefOrParkingCapacity().addAll(values);
        }
        return this;
    }

    @Override
    public ParkingCapacities_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public ParkingCapacities_RelStructure withId(String value) {
        setId(value);
        return this;
    }
