    ...
    extends ContainmentAggregationStructure
{
    ...
    public ActivationAssignments_RelStructure withActivationAssignmentRefOrActivationAssignment(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getActivationAssignmentRefOrActivationAssignment().add(value);
            }
        }
        return this;
    }

    public ActivationAssignments_RelStructure withActivationAssignmentRefOrActivationAssignment(Collection<Object> values) {
        if (values!= null) {
            getActivationAssignmentRefOrActivationAssignment().addAll(values);
        }
        return this;
    }

    @Override
    public ActivationAssignments_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public ActivationAssignments_RelStructure withId(String value) {
        setId(value);
        return this;
    }
