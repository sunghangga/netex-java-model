    ...
    extends OneToManyRelationshipStructure
{
    ...
    public ObjectRefs_RelStructure withVersionOfObjectRef(JAXBElement<? extends VersionOfObjectRefStructure> ... values) {
        if (values!= null) {
            for (JAXBElement<? extends VersionOfObjectRefStructure> value: values) {
                getVersionOfObjectRef().add(value);
            }
        }
        return this;
    }

    public ObjectRefs_RelStructure withVersionOfObjectRef(Collection<JAXBElement<? extends VersionOfObjectRefStructure>> values) {
        if (values!= null) {
            getVersionOfObjectRef().addAll(values);
        }
        return this;
    }

    @Override
    public ObjectRefs_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public ObjectRefs_RelStructure withId(String value) {
        setId(value);
        return this;
    }
