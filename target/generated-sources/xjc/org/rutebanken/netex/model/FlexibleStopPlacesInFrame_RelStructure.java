    ...
    extends ContainmentAggregationStructure
{
    ...
    public FlexibleStopPlacesInFrame_RelStructure withFlexibleStopPlace(FlexibleStopPlace... values) {
        if (values!= null) {
            for (FlexibleStopPlace value: values) {
                getFlexibleStopPlace().add(value);
            }
        }
        return this;
    }
    ...
    public FlexibleStopPlacesInFrame_RelStructure withFlexibleStopPlace(Collection<FlexibleStopPlace> values) {
        if (values!= null) {
            getFlexibleStopPlace().addAll(values);
        }
        return this;
    }
    ...
    @Override
    public FlexibleStopPlacesInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
