    ...
    extends ContainmentAggregationStructure
{
    ...
    public RoutingConstraintZonesInFrame_RelStructure withRoutingConstraintZone(RoutingConstraintZone... values) {
        if (values!= null) {
            for (RoutingConstraintZone value: values) {
                getRoutingConstraintZone().add(value);
            }
        }
        return this;
    }
    ...
    public RoutingConstraintZonesInFrame_RelStructure withRoutingConstraintZone(Collection<RoutingConstraintZone> values) {
        if (values!= null) {
            getRoutingConstraintZone().addAll(values);
        }
        return this;
    }
    ...
    @Override
    public RoutingConstraintZonesInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
