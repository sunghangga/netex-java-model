    ...
    extends ContainmentAggregationStructure
{
    ...
    public VehicleEntrances_RelStructure withVehicleEntranceRefOrVehicleEntrance(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getVehicleEntranceRefOrVehicleEntrance().add(value);
            }
        }
        return this;
    }

    public VehicleEntrances_RelStructure withVehicleEntranceRefOrVehicleEntrance(Collection<Object> values) {
        if (values!= null) {
            getVehicleEntranceRefOrVehicleEntrance().addAll(values);
        }
        return this;
    }

    @Override
    public VehicleEntrances_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public VehicleEntrances_RelStructure withId(String value) {
        setId(value);
        return this;
    }
