    ...
    extends ContainmentAggregationStructure
{
    ...
    public TopographicPlacesInFrame_RelStructure withTopographicPlace(TopographicPlace... values) {
        if (values!= null) {
            for (TopographicPlace value: values) {
                getTopographicPlace().add(value);
            }
        }
        return this;
    }

    public TopographicPlacesInFrame_RelStructure withTopographicPlace(Collection<TopographicPlace> values) {
        if (values!= null) {
            getTopographicPlace().addAll(values);
        }
        return this;
    }

    @Override
    public TopographicPlacesInFrame_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public TopographicPlacesInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
