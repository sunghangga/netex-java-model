    ...
    extends StrictContainmentAggregationStructure
{
    ...
    public JourneyWaitTimes_RelStructure withJourneyWaitTime(JourneyWaitTime... values) {
        if (values!= null) {
            for (JourneyWaitTime value: values) {
                getJourneyWaitTime().add(value);
            }
        }
        return this;
    }

    public JourneyWaitTimes_RelStructure withJourneyWaitTime(Collection<JourneyWaitTime> values) {
        if (values!= null) {
            getJourneyWaitTime().addAll(values);
        }
        return this;
    }

    @Override
    public JourneyWaitTimes_RelStructure withId(String value) {
        setId(value);
        return this;
    }
