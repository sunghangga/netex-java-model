    ...
    extends ContainmentAggregationStructure
{
    ...
    public ServiceFacilitySets_RelStructure withServiceFacilitySetRefOrServiceFacilitySet(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getServiceFacilitySetRefOrServiceFacilitySet().add(value);
            }
        }
        return this;
    }

    public ServiceFacilitySets_RelStructure withServiceFacilitySetRefOrServiceFacilitySet(Collection<Object> values) {
        if (values!= null) {
            getServiceFacilitySetRefOrServiceFacilitySet().addAll(values);
        }
        return this;
    }

    @Override
    public ServiceFacilitySets_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public ServiceFacilitySets_RelStructure withId(String value) {
        setId(value);
        return this;
    }
