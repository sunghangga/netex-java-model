    ...
    extends Operator_VersionStructure
{
    ...
    @Override
    public Operator withOperatorActivities(Collection<OperatorActivitiesEnumeration> values) {
        if (values!= null) {
    ...
    @Override
    public Operator withOrganisationType(Collection<OrganisationTypeEnumeration> values) {
        if (values!= null) {
    ...
    @Override
    public Operator withValidBetween(Collection<ValidBetween> values) {
        if (values!= null) {
    ...
    @Override
    public Operator withCreated(LocalDateTime value) {
        setCreated(value);
        return this;
    }

    @Override
    public Operator withChanged(LocalDateTime value) {
        setChanged(value);
        return this;
    }
