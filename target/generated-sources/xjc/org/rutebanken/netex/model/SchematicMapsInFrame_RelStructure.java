    ...
    extends ContainmentAggregationStructure
{
    ...
    public SchematicMapsInFrame_RelStructure withSchematicMap(SchematicMap... values) {
        if (values!= null) {
            for (SchematicMap value: values) {
                getSchematicMap().add(value);
            }
        }
        return this;
    }

    public SchematicMapsInFrame_RelStructure withSchematicMap(Collection<SchematicMap> values) {
        if (values!= null) {
            getSchematicMap().addAll(values);
        }
        return this;
    }

    @Override
    public SchematicMapsInFrame_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public SchematicMapsInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
