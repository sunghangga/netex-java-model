    ...
    extends ContainmentAggregationStructure
{
    ...
    public JourneyPatternsInFrame_RelStructure withJourneyPattern_OrJourneyPatternView(JAXBElement<?> ... values) {
        if (values!= null) {
            for (JAXBElement<?> value: values) {
                getJourneyPattern_OrJourneyPatternView().add(value);
            }
        }
        return this;
    }
    ...
    public JourneyPatternsInFrame_RelStructure withJourneyPattern_OrJourneyPatternView(Collection<JAXBElement<?>> values) {
        if (values!= null) {
            getJourneyPattern_OrJourneyPatternView().addAll(values);
        }
        return this;
    }
    ...
    @Override
    public JourneyPatternsInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
