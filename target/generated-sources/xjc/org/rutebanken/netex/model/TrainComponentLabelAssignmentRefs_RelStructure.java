...
/**
 * <p>Java class for TrainComponentLabelAssignmentRefs_RelStructure complex type.
 * 
...
public class TrainComponentLabelAssignmentRefs_RelStructure
    extends OneToManyRelationshipStructure
{
    ...
    public TrainComponentLabelAssignmentRefs_RelStructure withTrainComponentLabelAssignmentRef(TrainComponentLabelAssignmentRefStructure... values) {
        if (values!= null) {
            for (TrainComponentLabelAssignmentRefStructure value: values) {
                getTrainComponentLabelAssignmentRef().add(value);
            }
        }
        return this;
    }
    ...
    public TrainComponentLabelAssignmentRefs_RelStructure withTrainComponentLabelAssignmentRef(Collection<TrainComponentLabelAssignmentRefStructure> values) {
        if (values!= null) {
            getTrainComponentLabelAssignmentRef().addAll(values);
        }
        return this;
    }
    ...
    @Override
    public TrainComponentLabelAssignmentRefs_RelStructure withId(String value) {
        setId(value);
        return this;
    }
