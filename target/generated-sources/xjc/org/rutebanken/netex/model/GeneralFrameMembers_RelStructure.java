...
/**
 * <p>Java class for generalFrameMembers_RelStructure complex type.
 * 
...
@XmlType(name = "generalFrameMembers_RelStructure", propOrder = {
    "generalFrameMemberOrDataManagedObjectOrEntity_Entity"
})
@XmlSeeAlso({
    org.rutebanken.netex.model.General_VersionFrameStructure.Members.class
})
public class GeneralFrameMembers_RelStructure
    extends ContainmentAggregationStructure
{
    ...
    protected List<JAXBElement<? extends EntityStructure>> generalFrameMemberOrDataManagedObjectOrEntity_Entity;
     ...
     * <pre>
     *    getGeneralFrameMemberOrDataManagedObjectOrEntity_Entity().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * {@link JAXBElement }{@code <}{@link Entity_EntityStructure }{@code >}
     ...
     * 
     */
    public List<JAXBElement<? extends EntityStructure>> getGeneralFrameMemberOrDataManagedObjectOrEntity_Entity() {
        if (generalFrameMemberOrDataManagedObjectOrEntity_Entity == null) {
            generalFrameMemberOrDataManagedObjectOrEntity_Entity = new ArrayList<JAXBElement<? extends EntityStructure>>();
        }
        return this.generalFrameMemberOrDataManagedObjectOrEntity_Entity;
    }

    public GeneralFrameMembers_RelStructure withGeneralFrameMemberOrDataManagedObjectOrEntity_Entity(JAXBElement<? extends EntityStructure> ... values) {
        if (values!= null) {
    ...
    public GeneralFrameMembers_RelStructure withGeneralFrameMemberOrDataManagedObjectOrEntity_Entity(Collection<JAXBElement<? extends EntityStructure>> values) {
        if (values!= null) {
    ...
    @Override
    public GeneralFrameMembers_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public GeneralFrameMembers_RelStructure withId(String value) {
        setId(value);
        return this;
    }
