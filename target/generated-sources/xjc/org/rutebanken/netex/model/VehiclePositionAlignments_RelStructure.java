    ...
    extends ContainmentAggregationStructure
{
    ...
    public VehiclePositionAlignments_RelStructure withVehiclePositionAlignment(VehiclePositionAlignment... values) {
        if (values!= null) {
            for (VehiclePositionAlignment value: values) {
                getVehiclePositionAlignment().add(value);
            }
        }
        return this;
    }

    public VehiclePositionAlignments_RelStructure withVehiclePositionAlignment(Collection<VehiclePositionAlignment> values) {
        if (values!= null) {
            getVehiclePositionAlignment().addAll(values);
        }
        return this;
    }

    @Override
    public VehiclePositionAlignments_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public VehiclePositionAlignments_RelStructure withId(String value) {
        setId(value);
        return this;
    }
