    ...
    extends ContainmentAggregationStructure
{
    ...
    public ParkingBays_RelStructure withParkingBayRefOrParkingBay(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getParkingBayRefOrParkingBay().add(value);
            }
        }
        return this;
    }

    public ParkingBays_RelStructure withParkingBayRefOrParkingBay(Collection<Object> values) {
        if (values!= null) {
            getParkingBayRefOrParkingBay().addAll(values);
        }
        return this;
    }

    @Override
    public ParkingBays_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public ParkingBays_RelStructure withId(String value) {
        setId(value);
        return this;
    }
