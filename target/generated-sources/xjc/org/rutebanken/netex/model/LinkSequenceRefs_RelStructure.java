    ...
    extends OneToManyRelationshipStructure
{
    ...
    public LinkSequenceRefs_RelStructure withLinkSequenceRef(JAXBElement<? extends LinkSequenceRefStructure> ... values) {
        if (values!= null) {
            for (JAXBElement<? extends LinkSequenceRefStructure> value: values) {
                getLinkSequenceRef().add(value);
            }
        }
        return this;
    }

    public LinkSequenceRefs_RelStructure withLinkSequenceRef(Collection<JAXBElement<? extends LinkSequenceRefStructure>> values) {
        if (values!= null) {
            getLinkSequenceRef().addAll(values);
        }
        return this;
    }

    @Override
    public LinkSequenceRefs_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public LinkSequenceRefs_RelStructure withId(String value) {
        setId(value);
        return this;
    }
