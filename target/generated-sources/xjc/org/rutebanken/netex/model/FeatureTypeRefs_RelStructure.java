    ...
    extends OneToManyRelationshipStructure
{
    ...
    /**
     * Gets the value of the typeOfFeatureRef property.
     * 
     * <p>
    ...
    public FeatureTypeRefs_RelStructure withTypeOfFeatureRef(TypeOfFeatureRefStructure... values) {
        if (values!= null) {
            for (TypeOfFeatureRefStructure value: values) {
                getTypeOfFeatureRef().add(value);
            }
        }
        return this;
    }

    public FeatureTypeRefs_RelStructure withTypeOfFeatureRef(Collection<TypeOfFeatureRefStructure> values) {
        if (values!= null) {
            getTypeOfFeatureRef().addAll(values);
        }
        return this;
    }

    @Override
    public FeatureTypeRefs_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public FeatureTypeRefs_RelStructure withId(String value) {
        setId(value);
        return this;
    }
