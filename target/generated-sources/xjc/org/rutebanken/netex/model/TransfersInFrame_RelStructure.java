    ...
    extends ContainmentAggregationStructure
{
    ...
    public TransfersInFrame_RelStructure withTransfer(JAXBElement<? extends Transfer_VersionStructure> ... values) {
        if (values!= null) {
            for (JAXBElement<? extends Transfer_VersionStructure> value: values) {
                getTransfer().add(value);
            }
        }
        return this;
    }
    ...
    @Override
    public TransfersInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
