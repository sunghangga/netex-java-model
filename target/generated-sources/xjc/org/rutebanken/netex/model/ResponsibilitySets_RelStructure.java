    ...
    extends ContainmentAggregationStructure
{
    ...
    public ResponsibilitySets_RelStructure withResponsibilitySetRefOrResponsibilitySet(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getResponsibilitySetRefOrResponsibilitySet().add(value);
            }
        }
        return this;
    }

    public ResponsibilitySets_RelStructure withResponsibilitySetRefOrResponsibilitySet(Collection<Object> values) {
        if (values!= null) {
            getResponsibilitySetRefOrResponsibilitySet().addAll(values);
        }
        return this;
    }

    @Override
    public ResponsibilitySets_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public ResponsibilitySets_RelStructure withId(String value) {
        setId(value);
        return this;
    }
