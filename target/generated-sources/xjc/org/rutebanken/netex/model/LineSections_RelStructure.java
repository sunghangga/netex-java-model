    ...
    extends ContainmentAggregationStructure
{
    ...
    public LineSections_RelStructure withLineSectionRefOrLineSection(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getLineSectionRefOrLineSection().add(value);
            }
        }
        return this;
    }

    public LineSections_RelStructure withLineSectionRefOrLineSection(Collection<Object> values) {
        if (values!= null) {
            getLineSectionRefOrLineSection().addAll(values);
        }
        return this;
    }

    @Override
    public LineSections_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public LineSections_RelStructure withId(String value) {
        setId(value);
        return this;
    }
