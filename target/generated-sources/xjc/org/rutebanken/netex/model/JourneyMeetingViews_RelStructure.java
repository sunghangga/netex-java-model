...
/**
 * <p>Java class for journeyMeetingViews_RelStructure complex type.
 * 
...
public class JourneyMeetingViews_RelStructure
    extends StrictContainmentAggregationStructure
{

    @XmlElements({
        @XmlElement(name = "JourneyMeetingRef", type = JourneyMeetingRefStructure.class),
        @XmlElement(name = "JourneyMeetingView", type = JourneyMeeting_DerivedViewStructure.class)
    })
     ...
     * {@link JourneyMeeting_DerivedViewStructure }
     * 
     * 
     */
    ...
    public JourneyMeetingViews_RelStructure withJourneyMeetingRefOrJourneyMeetingView(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getJourneyMeetingRefOrJourneyMeetingView().add(value);
            }
        }
        return this;
    }

    public JourneyMeetingViews_RelStructure withJourneyMeetingRefOrJourneyMeetingView(Collection<Object> values) {
        if (values!= null) {
            getJourneyMeetingRefOrJourneyMeetingView().addAll(values);
        }
        return this;
    }

    @Override
    public JourneyMeetingViews_RelStructure withId(String value) {
        setId(value);
        return this;
    }
