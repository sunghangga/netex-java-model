    ...
    extends OneToManyRelationshipStructure
{
    ...
    public SiteRefs_RelStructure withSiteRef(JAXBElement<? extends SiteRefStructure> ... values) {
        if (values!= null) {
            for (JAXBElement<? extends SiteRefStructure> value: values) {
                getSiteRef().add(value);
            }
        }
        return this;
    }

    public SiteRefs_RelStructure withSiteRef(Collection<JAXBElement<? extends SiteRefStructure>> values) {
        if (values!= null) {
            getSiteRef().addAll(values);
        }
        return this;
    }

    @Override
    public SiteRefs_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public SiteRefs_RelStructure withId(String value) {
        setId(value);
        return this;
    }
