    ...
    extends VersionOfObjectRefStructure
{
    ...
    @Override
    public JourneyTimingRefStructure withValue(String value) {
        setValue(value);
        return this;
    }

    @Override
    public JourneyTimingRefStructure withNameOfRefClass(String value) {
        setNameOfRefClass(value);
        return this;
    }

    @Override
    public JourneyTimingRefStructure withModification(ModificationEnumeration value) {
        setModification(value);
        return this;
    }

    @Override
    public JourneyTimingRefStructure withRef(String value) {
        setRef(value);
        return this;
    }

    @Override
    public JourneyTimingRefStructure withVersionRef(String value) {
        setVersionRef(value);
        return this;
    }

    @Override
    public JourneyTimingRefStructure withCreated(LocalDateTime value) {
        setCreated(value);
        return this;
    }

    @Override
    public JourneyTimingRefStructure withChanged(LocalDateTime value) {
        setChanged(value);
        return this;
    }

    @Override
    public JourneyTimingRefStructure withVersion(String value) {
        setVersion(value);
        return this;
    }
