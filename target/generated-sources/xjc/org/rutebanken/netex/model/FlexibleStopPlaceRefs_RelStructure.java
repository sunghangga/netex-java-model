    ...
    extends OneToManyRelationshipStructure
{
    ...
    public FlexibleStopPlaceRefs_RelStructure withFlexibleStopPlaceRef(FlexibleStopPlaceRefStructure... values) {
        if (values!= null) {
            for (FlexibleStopPlaceRefStructure value: values) {
                getFlexibleStopPlaceRef().add(value);
            }
        }
        return this;
    }

    public FlexibleStopPlaceRefs_RelStructure withFlexibleStopPlaceRef(Collection<FlexibleStopPlaceRefStructure> values) {
        if (values!= null) {
            getFlexibleStopPlaceRef().addAll(values);
        }
        return this;
    }

    @Override
    public FlexibleStopPlaceRefs_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public FlexibleStopPlaceRefs_RelStructure withId(String value) {
        setId(value);
        return this;
    }
