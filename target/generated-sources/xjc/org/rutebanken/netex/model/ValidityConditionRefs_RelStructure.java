    ...
    extends OneToManyRelationshipStructure
{
    ...
    public ValidityConditionRefs_RelStructure withValidityConditionRef(JAXBElement<? extends ValidityConditionRefStructure> ... values) {
        if (values!= null) {
            for (JAXBElement<? extends ValidityConditionRefStructure> value: values) {
                getValidityConditionRef().add(value);
            }
        }
        return this;
    }

    public ValidityConditionRefs_RelStructure withValidityConditionRef(Collection<JAXBElement<? extends ValidityConditionRefStructure>> values) {
        if (values!= null) {
            getValidityConditionRef().addAll(values);
        }
        return this;
    }

    @Override
    public ValidityConditionRefs_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public ValidityConditionRefs_RelStructure withId(String value) {
        setId(value);
        return this;
    }
