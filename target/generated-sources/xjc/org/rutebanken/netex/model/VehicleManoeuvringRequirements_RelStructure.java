    ...
    extends ContainmentAggregationStructure
{
    ...
    public VehicleManoeuvringRequirements_RelStructure withVehicleManoeuvringRequirementRefOrVehicleManoeuvringRequirement(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getVehicleManoeuvringRequirementRefOrVehicleManoeuvringRequirement().add(value);
            }
        }
        return this;
    }

    public VehicleManoeuvringRequirements_RelStructure withVehicleManoeuvringRequirementRefOrVehicleManoeuvringRequirement(Collection<Object> values) {
        if (values!= null) {
            getVehicleManoeuvringRequirementRefOrVehicleManoeuvringRequirement().addAll(values);
        }
        return this;
    }

    @Override
    public VehicleManoeuvringRequirements_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public VehicleManoeuvringRequirements_RelStructure withId(String value) {
        setId(value);
        return this;
    }
