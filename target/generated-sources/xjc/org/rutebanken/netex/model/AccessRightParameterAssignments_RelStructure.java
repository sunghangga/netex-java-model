...
/**
 * <p>Java class for accessRightParameterAssignments_RelStructure complex type.
 * 
...
public class AccessRightParameterAssignments_RelStructure
    extends ContainmentAggregationStructure
{
    ...
    public AccessRightParameterAssignments_RelStructure withAccessRightParameterAssignment_(JAXBElement<? extends DataManagedObjectStructure> ... values) {
        if (values!= null) {
    ...
    public AccessRightParameterAssignments_RelStructure withAccessRightParameterAssignment_(Collection<JAXBElement<? extends DataManagedObjectStructure>> values) {
        if (values!= null) {
    ...
    @Override
    public AccessRightParameterAssignments_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public AccessRightParameterAssignments_RelStructure withId(String value) {
        setId(value);
        return this;
    }
