...
/**
 * <p>Java class for residentialQualifications_RelStructure complex type.
 * 
...
public class ResidentialQualifications_RelStructure
    extends OneToManyRelationshipStructure
{
    ...
    public ResidentialQualifications_RelStructure withResidentialQualificationRefOrResidentialQualification(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getResidentialQualificationRefOrResidentialQualification().add(value);
            }
        }
        return this;
    }

    public ResidentialQualifications_RelStructure withResidentialQualificationRefOrResidentialQualification(Collection<Object> values) {
        if (values!= null) {
            getResidentialQualificationRefOrResidentialQualification().addAll(values);
        }
        return this;
    }

    @Override
    public ResidentialQualifications_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public ResidentialQualifications_RelStructure withId(String value) {
        setId(value);
        return this;
    }
