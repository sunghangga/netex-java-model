...
/**
 * <p>Java class for RetailDevices_RelStructure complex type.
 * 
...
public class RetailDevices_RelStructure
    extends ContainmentAggregationStructure
{
    ...
    public RetailDevices_RelStructure withRetailDeviceRefOrRetailDevice(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getRetailDeviceRefOrRetailDevice().add(value);
            }
        }
        return this;
    }
    ...
    public RetailDevices_RelStructure withRetailDeviceRefOrRetailDevice(Collection<Object> values) {
        if (values!= null) {
            getRetailDeviceRefOrRetailDevice().addAll(values);
        }
        return this;
    }
    ...
    @Override
    public RetailDevices_RelStructure withId(String value) {
        setId(value);
        return this;
    }
