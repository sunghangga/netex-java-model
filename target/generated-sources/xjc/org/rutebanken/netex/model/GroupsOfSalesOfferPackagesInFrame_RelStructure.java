...
/**
 * <p>Java class for groupsOfSalesOfferPackagesInFrame_RelStructure complex type.
 * 
...
public class GroupsOfSalesOfferPackagesInFrame_RelStructure
    extends FrameContainmentStructure
{
    ...
    public GroupsOfSalesOfferPackagesInFrame_RelStructure withGroupOfSalesOfferPackages(GroupOfSalesOfferPackages... values) {
        if (values!= null) {
            for (GroupOfSalesOfferPackages value: values) {
                getGroupOfSalesOfferPackages().add(value);
            }
        }
        return this;
    }

    public GroupsOfSalesOfferPackagesInFrame_RelStructure withGroupOfSalesOfferPackages(Collection<GroupOfSalesOfferPackages> values) {
        if (values!= null) {
            getGroupOfSalesOfferPackages().addAll(values);
        }
        return this;
    }

    @Override
    public GroupsOfSalesOfferPackagesInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
