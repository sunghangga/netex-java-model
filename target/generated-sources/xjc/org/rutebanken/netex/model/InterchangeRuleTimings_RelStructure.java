...
/**
 * <p>Java class for interchangeRuleTimings_RelStructure complex type.
 * 
...
public class InterchangeRuleTimings_RelStructure
    extends ContainmentAggregationStructure
{
    ...
    public InterchangeRuleTimings_RelStructure withInterchangeRuleTimingRefOrInterchangeRuleTiming(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getInterchangeRuleTimingRefOrInterchangeRuleTiming().add(value);
            }
        }
        return this;
    }

    public InterchangeRuleTimings_RelStructure withInterchangeRuleTimingRefOrInterchangeRuleTiming(Collection<Object> values) {
        if (values!= null) {
            getInterchangeRuleTimingRefOrInterchangeRuleTiming().addAll(values);
        }
        return this;
    }

    @Override
    public InterchangeRuleTimings_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public InterchangeRuleTimings_RelStructure withId(String value) {
        setId(value);
        return this;
    }
