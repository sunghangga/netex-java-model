    ...
    extends ContainmentAggregationStructure
{
    ...
    public DisplayAssignments_RelStructure withDisplayAssignmentRefOrDisplayAssignment(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getDisplayAssignmentRefOrDisplayAssignment().add(value);
            }
        }
        return this;
    }

    public DisplayAssignments_RelStructure withDisplayAssignmentRefOrDisplayAssignment(Collection<Object> values) {
        if (values!= null) {
            getDisplayAssignmentRefOrDisplayAssignment().addAll(values);
        }
        return this;
    }

    @Override
    public DisplayAssignments_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public DisplayAssignments_RelStructure withId(String value) {
        setId(value);
        return this;
    }
