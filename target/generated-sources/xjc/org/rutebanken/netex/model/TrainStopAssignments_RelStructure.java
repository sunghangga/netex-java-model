...
@XmlSeeAlso({
    org.rutebanken.netex.model.PassengerStopAssignment_VersionStructure.TrainElements.class
})
    ...
    extends ContainmentAggregationStructure
{
    ...
    public TrainStopAssignments_RelStructure withTrainStopAssignmentRefOrTrainStopAssignment(Object... values) {
        if (values!= null) {
    ...
    public TrainStopAssignments_RelStructure withTrainStopAssignmentRefOrTrainStopAssignment(Collection<Object> values) {
        if (values!= null) {
    ...
    @Override
    public TrainStopAssignments_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public TrainStopAssignments_RelStructure withId(String value) {
        setId(value);
        return this;
    }
