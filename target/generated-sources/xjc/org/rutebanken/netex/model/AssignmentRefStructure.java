    ...
    extends OrderedVersionOfObjectRefStructure
{
    ...
    @Override
    public AssignmentRefStructure withOrder(BigInteger value) {
        setOrder(value);
        return this;
    }

    @Override
    public AssignmentRefStructure withValue(String value) {
        setValue(value);
        return this;
    }

    @Override
    public AssignmentRefStructure withNameOfRefClass(String value) {
        setNameOfRefClass(value);
        return this;
    }

    @Override
    public AssignmentRefStructure withModification(ModificationEnumeration value) {
        setModification(value);
        return this;
    }

    @Override
    public AssignmentRefStructure withRef(String value) {
        setRef(value);
        return this;
    }

    @Override
    public AssignmentRefStructure withVersionRef(String value) {
        setVersionRef(value);
        return this;
    }

    @Override
    public AssignmentRefStructure withCreated(LocalDateTime value) {
        setCreated(value);
        return this;
    }

    @Override
    public AssignmentRefStructure withChanged(LocalDateTime value) {
        setChanged(value);
        return this;
    }

    @Override
    public AssignmentRefStructure withVersion(String value) {
        setVersion(value);
        return this;
    }
