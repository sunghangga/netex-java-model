...
/**
 * <p>Java class for blacklists_RelStructure complex type.
 * 
...
public class Blacklists_RelStructure
    extends ContainmentAggregationStructure
{
    ...
    public Blacklists_RelStructure withBlacklistRefOrBlacklist(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getBlacklistRefOrBlacklist().add(value);
            }
        }
        return this;
    }

    public Blacklists_RelStructure withBlacklistRefOrBlacklist(Collection<Object> values) {
        if (values!= null) {
            getBlacklistRefOrBlacklist().addAll(values);
        }
        return this;
    }

    @Override
    public Blacklists_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public Blacklists_RelStructure withId(String value) {
        setId(value);
        return this;
    }
