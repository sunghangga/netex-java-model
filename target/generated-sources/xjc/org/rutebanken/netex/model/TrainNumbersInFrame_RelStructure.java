...
/**
 * <p>Java class for trainNumbersInFrame_RelStructure complex type.
 * 
...
public class TrainNumbersInFrame_RelStructure
    extends ContainmentAggregationStructure
{
    ...
    public TrainNumbersInFrame_RelStructure withTrainNumberOrTrainNumberRef(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getTrainNumberOrTrainNumberRef().add(value);
            }
        }
        return this;
    }

    public TrainNumbersInFrame_RelStructure withTrainNumberOrTrainNumberRef(Collection<Object> values) {
        if (values!= null) {
            getTrainNumberOrTrainNumberRef().addAll(values);
        }
        return this;
    }

    @Override
    public TrainNumbersInFrame_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public TrainNumbersInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
