...
/**
 * <p>Java class for explicitJourneyRefs_RelStructure complex type.
 * 
...
public class ExplicitJourneyRefs_RelStructure
    extends OneToManyRelationshipStructure
{
    ...
    public ExplicitJourneyRefs_RelStructure withServiceJourneyRefOrVehicleJourneyRef(JAXBElement<? extends JourneyRefStructure> ... values) {
        if (values!= null) {
            for (JAXBElement<? extends JourneyRefStructure> value: values) {
                getServiceJourneyRefOrVehicleJourneyRef().add(value);
            }
        }
        return this;
    }
    ...
    public ExplicitJourneyRefs_RelStructure withServiceJourneyRefOrVehicleJourneyRef(Collection<JAXBElement<? extends JourneyRefStructure>> values) {
        if (values!= null) {
            getServiceJourneyRefOrVehicleJourneyRef().addAll(values);
        }
        return this;
    }
    ...
    @Override
    public ExplicitJourneyRefs_RelStructure withId(String value) {
        setId(value);
        return this;
    }
