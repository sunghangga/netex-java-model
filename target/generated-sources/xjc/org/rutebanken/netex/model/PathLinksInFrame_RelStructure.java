    ...
    extends ContainmentAggregationStructure
{
    ...
    public PathLinksInFrame_RelStructure withPathLink(PathLink... values) {
        if (values!= null) {
            for (PathLink value: values) {
                getPathLink().add(value);
            }
        }
        return this;
    }

    public PathLinksInFrame_RelStructure withPathLink(Collection<PathLink> values) {
        if (values!= null) {
            getPathLink().addAll(values);
        }
        return this;
    }

    @Override
    public PathLinksInFrame_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public PathLinksInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
