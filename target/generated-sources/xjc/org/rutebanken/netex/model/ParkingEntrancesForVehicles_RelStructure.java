    ...
    extends ContainmentAggregationStructure
{
    ...
    public ParkingEntrancesForVehicles_RelStructure withParkingEntranceForVehiclesRefOrParkingEntranceForVehicles(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getParkingEntranceForVehiclesRefOrParkingEntranceForVehicles().add(value);
            }
        }
        return this;
    }

    public ParkingEntrancesForVehicles_RelStructure withParkingEntranceForVehiclesRefOrParkingEntranceForVehicles(Collection<Object> values) {
        if (values!= null) {
            getParkingEntranceForVehiclesRefOrParkingEntranceForVehicles().addAll(values);
        }
        return this;
    }

    @Override
    public ParkingEntrancesForVehicles_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public ParkingEntrancesForVehicles_RelStructure withId(String value) {
        setId(value);
        return this;
    }
