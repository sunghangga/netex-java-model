    ...
    extends OneToManyRelationshipStructure
{
    ...
    public Codespaces_RelStructure withCodespaceRefOrCodespace(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getCodespaceRefOrCodespace().add(value);
            }
        }
        return this;
    }

    public Codespaces_RelStructure withCodespaceRefOrCodespace(Collection<Object> values) {
        if (values!= null) {
            getCodespaceRefOrCodespace().addAll(values);
        }
        return this;
    }

    @Override
    public Codespaces_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public Codespaces_RelStructure withId(String value) {
        setId(value);
        return this;
    }
