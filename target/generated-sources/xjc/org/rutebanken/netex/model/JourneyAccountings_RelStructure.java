...
/**
 * <p>Java class for journeyAccountings_RelStructure complex type.
 * 
...
public class JourneyAccountings_RelStructure
    extends ContainmentAggregationStructure
{
    ...
    public JourneyAccountings_RelStructure withJourneyAccountingRefOrJourneyAccounting(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getJourneyAccountingRefOrJourneyAccounting().add(value);
            }
        }
        return this;
    }

    public JourneyAccountings_RelStructure withJourneyAccountingRefOrJourneyAccounting(Collection<Object> values) {
        if (values!= null) {
            getJourneyAccountingRefOrJourneyAccounting().addAll(values);
        }
        return this;
    }

    @Override
    public JourneyAccountings_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public JourneyAccountings_RelStructure withId(String value) {
        setId(value);
        return this;
    }
