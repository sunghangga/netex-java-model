    ...
    extends ContainmentAggregationStructure
{
    ...
    /**
     * Gets the value of the lineNetwork property.
     * 
     * <p>
    ...
    public LineNetworksInFrame_RelStructure withLineNetwork(LineNetwork... values) {
        if (values!= null) {
            for (LineNetwork value: values) {
                getLineNetwork().add(value);
            }
        }
        return this;
    }

    public LineNetworksInFrame_RelStructure withLineNetwork(Collection<LineNetwork> values) {
        if (values!= null) {
            getLineNetwork().addAll(values);
        }
        return this;
    }

    @Override
    public LineNetworksInFrame_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public LineNetworksInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
