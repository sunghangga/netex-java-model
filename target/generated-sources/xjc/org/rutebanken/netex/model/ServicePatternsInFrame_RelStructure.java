    ...
    extends ContainmentAggregationStructure
{
    ...
    public ServicePatternsInFrame_RelStructure withServicePatternOrJourneyPatternView(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getServicePatternOrJourneyPatternView().add(value);
            }
        }
        return this;
    }

    public ServicePatternsInFrame_RelStructure withServicePatternOrJourneyPatternView(Collection<Object> values) {
        if (values!= null) {
            getServicePatternOrJourneyPatternView().addAll(values);
        }
        return this;
    }

    @Override
    public ServicePatternsInFrame_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public ServicePatternsInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
