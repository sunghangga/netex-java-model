    ...
    extends ContainmentAggregationStructure
{
    ...
    public LocalServices_RelStructure withLocalServiceRefOrLocalService(JAXBElement<?> ... values) {
        if (values!= null) {
            for (JAXBElement<?> value: values) {
                getLocalServiceRefOrLocalService().add(value);
            }
        }
        return this;
    }

    public LocalServices_RelStructure withLocalServiceRefOrLocalService(Collection<JAXBElement<?>> values) {
        if (values!= null) {
            getLocalServiceRefOrLocalService().addAll(values);
        }
        return this;
    }

    @Override
    public LocalServices_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public LocalServices_RelStructure withId(String value) {
        setId(value);
        return this;
    }
