    ...
    extends OneToManyRelationshipStructure
{
    ...
    public QuayRefs_RelStructure withQuayRef(QuayRefStructure... values) {
        if (values!= null) {
            for (QuayRefStructure value: values) {
                getQuayRef().add(value);
            }
        }
        return this;
    }

    public QuayRefs_RelStructure withQuayRef(Collection<QuayRefStructure> values) {
        if (values!= null) {
            getQuayRef().addAll(values);
        }
        return this;
    }

    @Override
    public QuayRefs_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public QuayRefs_RelStructure withId(String value) {
        setId(value);
        return this;
    }
