    ...
    extends ContainmentAggregationStructure
{
    ...
    public PlaceEquipments_RelStructure withInstalledEquipmentRefOrInstalledEquipment(JAXBElement<?> ... values) {
        if (values!= null) {
            for (JAXBElement<?> value: values) {
                getInstalledEquipmentRefOrInstalledEquipment().add(value);
            }
        }
        return this;
    }

    public PlaceEquipments_RelStructure withInstalledEquipmentRefOrInstalledEquipment(Collection<JAXBElement<?>> values) {
        if (values!= null) {
            getInstalledEquipmentRefOrInstalledEquipment().addAll(values);
        }
        return this;
    }

    @Override
    public PlaceEquipments_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public PlaceEquipments_RelStructure withId(String value) {
        setId(value);
        return this;
    }
