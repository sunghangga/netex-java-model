...
/**
 * <p>Java class for qualityStructureFactorPrices_RelStructure complex type.
 * 
...
public class QualityStructureFactorPrices_RelStructure
    extends StrictContainmentAggregationStructure
{
    ...
    protected List<JAXBElement<?>> qualityStructureFactorPriceRefOrQualityStructureFactorPriceOrCellRef_;
     ...
     * This is why there is not a <CODE>set</CODE> method for the qualityStructureFactorPriceRefOrQualityStructureFactorPriceOrCellRef property.
     * 
     * <p>
     ...
     * {@link JAXBElement }{@code <}{@link QualityStructureFactorPrice_VersionedChildStructure }{@code >}
    ...
    public List<JAXBElement<?>> getQualityStructureFactorPriceRefOrQualityStructureFactorPriceOrCellRef_() {
        if (qualityStructureFactorPriceRefOrQualityStructureFactorPriceOrCellRef_ == null) {
            qualityStructureFactorPriceRefOrQualityStructureFactorPriceOrCellRef_ = new ArrayList<JAXBElement<?>>();
        }
        return this.qualityStructureFactorPriceRefOrQualityStructureFactorPriceOrCellRef_;
    }
    ...
    public QualityStructureFactorPrices_RelStructure withQualityStructureFactorPriceRefOrQualityStructureFactorPriceOrCellRef_(JAXBElement<?> ... values) {
        if (values!= null) {
            for (JAXBElement<?> value: values) {
                getQualityStructureFactorPriceRefOrQualityStructureFactorPriceOrCellRef_().add(value);
            }
        }
        return this;
    }
    ...
    public QualityStructureFactorPrices_RelStructure withQualityStructureFactorPriceRefOrQualityStructureFactorPriceOrCellRef_(Collection<JAXBElement<?>> values) {
        if (values!= null) {
            getQualityStructureFactorPriceRefOrQualityStructureFactorPriceOrCellRef_().addAll(values);
        }
        return this;
    }
