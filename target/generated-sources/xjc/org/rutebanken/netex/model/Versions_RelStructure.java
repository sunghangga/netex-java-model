    ...
    extends ContainmentAggregationStructure
{
    ...
    public Versions_RelStructure withVersionRefOrVersion(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getVersionRefOrVersion().add(value);
            }
        }
        return this;
    }

    public Versions_RelStructure withVersionRefOrVersion(Collection<Object> values) {
        if (values!= null) {
            getVersionRefOrVersion().addAll(values);
        }
        return this;
    }

    @Override
    public Versions_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public Versions_RelStructure withId(String value) {
        setId(value);
        return this;
    }
