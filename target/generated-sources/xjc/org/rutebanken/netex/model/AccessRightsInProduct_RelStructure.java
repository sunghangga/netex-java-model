...
/**
 * <p>Java class for accessRightsInProduct_RelStructure complex type.
 * 
...
public class AccessRightsInProduct_RelStructure
    extends StrictContainmentAggregationStructure
{

    @XmlElements({
        @XmlElement(name = "AccessRightInProductRef", type = AccessRightInProductRefStructure.class),
        @XmlElement(name = "AccessRightInProduct", type = AccessRightInProduct_VersionedChildStructure.class)
    })
     ...
     * {@link AccessRightInProduct_VersionedChildStructure }
     * 
     * 
     */
    ...
    public AccessRightsInProduct_RelStructure withAccessRightInProductRefOrAccessRightInProduct(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getAccessRightInProductRefOrAccessRightInProduct().add(value);
            }
        }
        return this;
    }

    public AccessRightsInProduct_RelStructure withAccessRightInProductRefOrAccessRightInProduct(Collection<Object> values) {
        if (values!= null) {
            getAccessRightInProductRefOrAccessRightInProduct().addAll(values);
        }
        return this;
    }

    @Override
    public AccessRightsInProduct_RelStructure withId(String value) {
        setId(value);
        return this;
    }
