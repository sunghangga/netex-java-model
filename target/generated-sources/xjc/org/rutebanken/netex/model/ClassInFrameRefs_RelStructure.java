    ...
    extends OneToManyRelationshipStructure
{
    ...
    public ClassInFrameRefs_RelStructure withClassInFrameRef(ClassInFrameRefStructure... values) {
        if (values!= null) {
            for (ClassInFrameRefStructure value: values) {
                getClassInFrameRef().add(value);
            }
        }
        return this;
    }

    public ClassInFrameRefs_RelStructure withClassInFrameRef(Collection<ClassInFrameRefStructure> values) {
        if (values!= null) {
            getClassInFrameRef().addAll(values);
        }
        return this;
    }

    @Override
    public ClassInFrameRefs_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public ClassInFrameRefs_RelStructure withId(String value) {
        setId(value);
        return this;
    }
