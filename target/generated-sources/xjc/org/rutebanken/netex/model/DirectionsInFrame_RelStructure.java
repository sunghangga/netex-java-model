    ...
    extends ContainmentAggregationStructure
{
    ...
    public DirectionsInFrame_RelStructure withDirection(Direction... values) {
        if (values!= null) {
    ...
    public DirectionsInFrame_RelStructure withDirection(Collection<Direction> values) {
        if (values!= null) {
    ...
    @Override
    public DirectionsInFrame_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public DirectionsInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
