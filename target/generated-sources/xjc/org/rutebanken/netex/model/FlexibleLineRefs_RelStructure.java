    ...
    extends OneToManyRelationshipStructure
{
    ...
    public FlexibleLineRefs_RelStructure withFlexibleLineRef(FlexibleLineRefStructure... values) {
        if (values!= null) {
            for (FlexibleLineRefStructure value: values) {
                getFlexibleLineRef().add(value);
            }
        }
        return this;
    }
    ...
    public FlexibleLineRefs_RelStructure withFlexibleLineRef(Collection<FlexibleLineRefStructure> values) {
        if (values!= null) {
            getFlexibleLineRef().addAll(values);
        }
        return this;
    }
    ...
    @Override
    public FlexibleLineRefs_RelStructure withId(String value) {
        setId(value);
        return this;
    }
