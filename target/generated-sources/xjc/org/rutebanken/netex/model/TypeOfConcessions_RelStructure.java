...
/**
 * <p>Java class for typeOfConcessions_RelStructure complex type.
 * 
...
public class TypeOfConcessions_RelStructure
    extends ContainmentAggregationStructure
{
    ...
    public TypeOfConcessions_RelStructure withTypeOfConcessionRefOrTypeOfConcession(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getTypeOfConcessionRefOrTypeOfConcession().add(value);
            }
        }
        return this;
    }

    public TypeOfConcessions_RelStructure withTypeOfConcessionRefOrTypeOfConcession(Collection<Object> values) {
        if (values!= null) {
            getTypeOfConcessionRefOrTypeOfConcession().addAll(values);
        }
        return this;
    }

    @Override
    public TypeOfConcessions_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public TypeOfConcessions_RelStructure withId(String value) {
        setId(value);
        return this;
    }
