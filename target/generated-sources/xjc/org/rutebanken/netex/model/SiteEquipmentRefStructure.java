    ...
    extends EquipmentRefStructure
{
    ...
    @Override
    public SiteEquipmentRefStructure withValue(String value) {
        setValue(value);
        return this;
    }

    @Override
    public SiteEquipmentRefStructure withNameOfRefClass(String value) {
        setNameOfRefClass(value);
        return this;
    }

    @Override
    public SiteEquipmentRefStructure withModification(ModificationEnumeration value) {
        setModification(value);
        return this;
    }

    @Override
    public SiteEquipmentRefStructure withRef(String value) {
        setRef(value);
        return this;
    }

    @Override
    public SiteEquipmentRefStructure withVersionRef(String value) {
        setVersionRef(value);
        return this;
    }

    @Override
    public SiteEquipmentRefStructure withCreated(LocalDateTime value) {
        setCreated(value);
        return this;
    }

    @Override
    public SiteEquipmentRefStructure withChanged(LocalDateTime value) {
        setChanged(value);
        return this;
    }

    @Override
    public SiteEquipmentRefStructure withVersion(String value) {
        setVersion(value);
        return this;
    }
