    ...
    extends OneToManyRelationshipStructure
{
    ...
    public AllowedLineDirectionRefs_RelStructure withAllowedLineDirectionRef(AllowedLineDirectionRefStructure... values) {
        if (values!= null) {
            for (AllowedLineDirectionRefStructure value: values) {
                getAllowedLineDirectionRef().add(value);
            }
        }
        return this;
    }

    public AllowedLineDirectionRefs_RelStructure withAllowedLineDirectionRef(Collection<AllowedLineDirectionRefStructure> values) {
        if (values!= null) {
            getAllowedLineDirectionRef().addAll(values);
        }
        return this;
    }

    @Override
    public AllowedLineDirectionRefs_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public AllowedLineDirectionRefs_RelStructure withId(String value) {
        setId(value);
        return this;
    }
