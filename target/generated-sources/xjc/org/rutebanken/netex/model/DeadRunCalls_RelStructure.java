...
/**
 * <p>Java class for deadRunCalls_RelStructure complex type.
 * 
...
public class DeadRunCalls_RelStructure
    extends StrictContainmentAggregationStructure
{

    @XmlElement(name = "DeadRunCall", required = true)
    protected List<DeadRunCall_VersionedChildStructure> deadRunCall;
     ...
     * {@link DeadRunCall_VersionedChildStructure }
     * 
     * 
     */
    public List<DeadRunCall_VersionedChildStructure> getDeadRunCall() {
        if (deadRunCall == null) {
            deadRunCall = new ArrayList<DeadRunCall_VersionedChildStructure>();
        }
    ...
    public DeadRunCalls_RelStructure withDeadRunCall(DeadRunCall_VersionedChildStructure... values) {
        if (values!= null) {
            for (DeadRunCall_VersionedChildStructure value: values) {
                getDeadRunCall().add(value);
            }
        }
        return this;
    }
