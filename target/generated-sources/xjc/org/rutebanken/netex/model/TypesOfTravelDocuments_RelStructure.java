...
/**
 * <p>Java class for typesOfTravelDocuments_RelStructure complex type.
 * 
...
public class TypesOfTravelDocuments_RelStructure
    extends ContainmentAggregationStructure
{
    ...
    public TypesOfTravelDocuments_RelStructure withTypeOfTravelDocumentRefOrTypeOfTravelDocument(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getTypeOfTravelDocumentRefOrTypeOfTravelDocument().add(value);
            }
        }
        return this;
    }

    public TypesOfTravelDocuments_RelStructure withTypeOfTravelDocumentRefOrTypeOfTravelDocument(Collection<Object> values) {
        if (values!= null) {
            getTypeOfTravelDocumentRefOrTypeOfTravelDocument().addAll(values);
        }
        return this;
    }

    @Override
    public TypesOfTravelDocuments_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public TypesOfTravelDocuments_RelStructure withId(String value) {
        setId(value);
        return this;
    }
