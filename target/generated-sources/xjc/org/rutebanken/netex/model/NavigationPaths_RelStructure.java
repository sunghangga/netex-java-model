    ...
    extends ContainmentAggregationStructure
{
    ...
    public NavigationPaths_RelStructure withNavigationPathRefOrNavigationPath(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getNavigationPathRefOrNavigationPath().add(value);
            }
        }
        return this;
    }

    public NavigationPaths_RelStructure withNavigationPathRefOrNavigationPath(Collection<Object> values) {
        if (values!= null) {
            getNavigationPathRefOrNavigationPath().addAll(values);
        }
        return this;
    }

    @Override
    public NavigationPaths_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public NavigationPaths_RelStructure withId(String value) {
        setId(value);
        return this;
    }
