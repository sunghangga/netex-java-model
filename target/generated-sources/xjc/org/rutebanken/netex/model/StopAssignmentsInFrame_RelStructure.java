    ...
    extends ContainmentAggregationStructure
{
    ...
    public StopAssignmentsInFrame_RelStructure withStopAssignment(JAXBElement<? extends StopAssignment_VersionStructure> ... values) {
        if (values!= null) {
            for (JAXBElement<? extends StopAssignment_VersionStructure> value: values) {
                getStopAssignment().add(value);
            }
        }
        return this;
    }
    ...
    public StopAssignmentsInFrame_RelStructure withStopAssignment(Collection<JAXBElement<? extends StopAssignment_VersionStructure>> values) {
        if (values!= null) {
            getStopAssignment().addAll(values);
        }
        return this;
    }
    ...
    @Override
    public StopAssignmentsInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
