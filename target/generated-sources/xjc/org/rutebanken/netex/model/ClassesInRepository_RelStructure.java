    ...
    extends OneToManyRelationshipStructure
{
    ...
    public ClassesInRepository_RelStructure withClassInFrameRefOrClassInFrame(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getClassInFrameRefOrClassInFrame().add(value);
            }
        }
        return this;
    }

    public ClassesInRepository_RelStructure withClassInFrameRefOrClassInFrame(Collection<Object> values) {
        if (values!= null) {
            getClassInFrameRefOrClassInFrame().addAll(values);
        }
        return this;
    }

    @Override
    public ClassesInRepository_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public ClassesInRepository_RelStructure withId(String value) {
        setId(value);
        return this;
    }
