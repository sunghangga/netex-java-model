    ...
    extends OneToManyRelationshipStructure
{
    ...
    public TransferRefs_RelStructure withTransferRef(JAXBElement<? extends TransferRefStructure> ... values) {
        if (values!= null) {
            for (JAXBElement<? extends TransferRefStructure> value: values) {
                getTransferRef().add(value);
            }
        }
        return this;
    }
    ...
    @Override
    public TransferRefs_RelStructure withId(String value) {
        setId(value);
        return this;
    }
