    ...
    extends ContainmentAggregationStructure
{
    ...
    public TransferRestrictionsInFrame_RelStructure withTransferRestriction(TransferRestriction... values) {
        if (values!= null) {
            for (TransferRestriction value: values) {
                getTransferRestriction().add(value);
            }
        }
        return this;
    }

    public TransferRestrictionsInFrame_RelStructure withTransferRestriction(Collection<TransferRestriction> values) {
        if (values!= null) {
            getTransferRestriction().addAll(values);
        }
        return this;
    }

    @Override
    public TransferRestrictionsInFrame_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public TransferRestrictionsInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
