...
/**
 * <p>Java class for serviceAccessRightRefs_RelStructure complex type.
 * 
...
public class ServiceAccessRightRefs_RelStructure
    extends OneToManyRelationshipStructure
{
    ...
    public ServiceAccessRightRefs_RelStructure withServiceAccessRightRef(JAXBElement<? extends ServiceAccessRightRefStructure> ... values) {
        if (values!= null) {
            for (JAXBElement<? extends ServiceAccessRightRefStructure> value: values) {
                getServiceAccessRightRef().add(value);
            }
        }
        return this;
    }

    public ServiceAccessRightRefs_RelStructure withServiceAccessRightRef(Collection<JAXBElement<? extends ServiceAccessRightRefStructure>> values) {
        if (values!= null) {
            getServiceAccessRightRef().addAll(values);
        }
        return this;
    }

    @Override
    public ServiceAccessRightRefs_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public ServiceAccessRightRefs_RelStructure withId(String value) {
        setId(value);
        return this;
    }
