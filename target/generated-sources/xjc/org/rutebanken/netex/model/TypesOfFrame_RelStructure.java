    ...
    extends OneToManyRelationshipStructure
{
    ...
    public TypesOfFrame_RelStructure withTypeOfFrameRefOrTypeOfFrame(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getTypeOfFrameRefOrTypeOfFrame().add(value);
            }
        }
        return this;
    }

    public TypesOfFrame_RelStructure withTypeOfFrameRefOrTypeOfFrame(Collection<Object> values) {
        if (values!= null) {
            getTypeOfFrameRefOrTypeOfFrame().addAll(values);
        }
        return this;
    }

    @Override
    public TypesOfFrame_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public TypesOfFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
