    ...
    extends ContainmentAggregationStructure
{
    ...
    public GroupOfTimebandsInFrame_RelStructure withGroupOfTimebands(GroupOfTimebands... values) {
        if (values!= null) {
            for (GroupOfTimebands value: values) {
                getGroupOfTimebands().add(value);
            }
        }
        return this;
    }
    ...
    public GroupOfTimebandsInFrame_RelStructure withGroupOfTimebands(Collection<GroupOfTimebands> values) {
        if (values!= null) {
            getGroupOfTimebands().addAll(values);
        }
        return this;
    }
    ...
    @Override
    public GroupOfTimebandsInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
