    ...
    extends ContainmentAggregationStructure
{
    ...
    public StopPlacesInFrame_RelStructure withStopPlace(StopPlace... values) {
        if (values!= null) {
    ...
    public StopPlacesInFrame_RelStructure withStopPlace(Collection<StopPlace> values) {
        if (values!= null) {
    ...
    @Override
    public StopPlacesInFrame_RelStructure withModificationSet(ModificationSetEnumeration value) {
        setModificationSet(value);
        return this;
    }

    @Override
    public StopPlacesInFrame_RelStructure withId(String value) {
        setId(value);
        return this;
    }
