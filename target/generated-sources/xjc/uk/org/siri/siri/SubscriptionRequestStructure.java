    ...
    extends AbstractSubscriptionRequestStructure
{
    ...
    public SubscriptionRequestStructure withAbstractFunctionalServiceSubscriptionRequest(Collection<JAXBElement<? extends AbstractSubscriptionStructure>> values) {
        if (values!= null) {
    ...
    @Override
    public SubscriptionRequestStructure withRequestTimestamp(LocalDateTime value) {
