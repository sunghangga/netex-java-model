    ...
    extends SubscriptionRequestStructure
{
    ...
    @Override
    public SubscriptionRequest withAbstractFunctionalServiceSubscriptionRequest(JAXBElement<? extends AbstractSubscriptionStructure> ... values) {
        if (values!= null) {
    ...
    @Override
    public SubscriptionRequest withAbstractFunctionalServiceSubscriptionRequest(Collection<JAXBElement<? extends AbstractSubscriptionStructure>> values) {
        if (values!= null) {
